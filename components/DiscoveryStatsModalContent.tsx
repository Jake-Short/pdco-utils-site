...
export default function DiscoveryStatsModalContent() {
	...
	const loadData = async () => {
		...
		const cadData = await(await fetch(`https://us-central1-healthy-earth-356019.cloudfunctions.net/discovery-stats?url=https://ssd-api.jpl.nasa.gov/cad.api?date-min=${cadStartDateString}%26date-max=${cadEndDateString}%26dist-max=1LD`)).json();
		let belowGeo = 0;
